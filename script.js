...
let cmsTableDemo = {
    'Bobby Jones': {
        'phone': '716-706-7060',
        'address': '1234 Daren Dragon Street , Mugen, Japan,906056'
    },
    'Yugai Gorjo': {
        'phone': '716-706-7060',
        'address': '9865 Daren Dragon Street , Mugen, Japan, 900156'
    }
};
...
let enableDisableNewUserModal = (option) => {
    ...
    if(option === 'enable')
        newPersonName.disable = false;
    else if (option === 'disable')
        newPersonName.disable = true;
}
...
let refreshDOMTable = () => {
    ...
    for (let i = 0; i < editBtns.length; i++) {
        editBtns[i].addEventListener('click', ($event) => {
            ...
            newPersonAddresss.value = personToEdit.Address;
            enableDisableNewUserModal('disable');
